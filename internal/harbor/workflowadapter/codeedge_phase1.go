...
const (
	...
	CodeEdgeSourceSnapshotArtifact        = "source_snapshot"
	CodeEdgeSourceSnapshotSchemaVersion   = "harbor.source-snapshot.v1"
...
func CodeEdgePhase1StageCatalog() StageCatalog {
	return StageCatalog{
		...
		Stages: []StageDefinition{
			stage(RepoPrepare, StageSourcePrepare, nil, "harborfactory.repo_prepare", []workflowkit.ResourceKey{resourceTaskSnapshot, resourceSourceSnapshot}, []workflowkit.ResourceKey{resourceEvidenceTaskLayout}, workflowkit.EffectEvidenceOnly, 1, checkVerdicts(), artifactInput("task_snapshot"), artifactInputWithSchema(CodeEdgeSourceSnapshotArtifact, CodeEdgeSourceSnapshotSchemaVersion), artifactOutput("task_layout_report")),
			stage(RepoAnalyze, StageSourcePrepare, []string{RepoPrepare}, "harborfactory.repo_analyze", []workflowkit.ResourceKey{resourceTaskSnapshot, resourceSourceSnapshot, resourceEvidenceTaskLayout}, []workflowkit.ResourceKey{resourceEvidenceRepoProvenance}, workflowkit.EffectEvidenceOnly, 1, checkVerdicts(), artifactInput("task_snapshot"), artifactInputWithSchema(CodeEdgeSourceSnapshotArtifact, CodeEdgeSourceSnapshotSchemaVersion), artifactInput("task_layout_report"), artifactOutput("repo_provenance_report")),
			stage(CodeEdgeLint, StageSourcePrepare, []string{RepoPrepare}, "harborfactory.codeedge_lint", []workflowkit.ResourceKey{resourceTaskSnapshot, resourceSourceSnapshot, resourceEvidenceTaskLayout}, []workflowkit.ResourceKey{resourceEvidenceEnvironmentIsolation}, workflowkit.EffectEvidenceOnly, 1, checkVerdicts(), artifactInput("task_snapshot"), artifactInputWithSchema(CodeEdgeSourceSnapshotArtifact, CodeEdgeSourceSnapshotSchemaVersion), artifactInput("task_layout_report"), artifactOutput("environment_isolation_report")),
			stage(DockerBuild, StageRuntimeVerify, []string{RepoAnalyze, CodeEdgeLint}, "harborfactory.docker_build", []workflowkit.ResourceKey{resourceTaskSnapshot, resourceSourceSnapshot, resourceEvidenceRepoProvenance, resourceEvidenceEnvironmentIsolation}, []workflowkit.ResourceKey{resourceEvidenceDockerBuild}, workflowkit.EffectEvidenceOnly, 1, checkVerdicts(), artifactInput("task_snapshot"), artifactInputWithSchema(CodeEdgeSourceSnapshotArtifact, CodeEdgeSourceSnapshotSchemaVersion), artifactInput("repo_provenance_report"), artifactInput("environment_isolation_report"), artifactOutput("docker_build_report")),
			stage(InitialVerify, StageRuntimeVerify, []string{DockerBuild}, "harborfactory.initial_verify", []workflowkit.ResourceKey{resourceTaskSnapshot, resourceSourceSnapshot, resourceEvidenceDockerBuild}, []workflowkit.ResourceKey{resourceEvidenceInitialVerify}, workflowkit.EffectEvidenceOnly, 1, checkVerdicts(), artifactInput("task_snapshot"), artifactInputWithSchema(CodeEdgeSourceSnapshotArtifact, CodeEdgeSourceSnapshotSchemaVersion), artifactInput("docker_build_report"), artifactOutput("initial_verify_report")),
			stage(OracleVerify, StageRuntimeVerify, []string{InitialVerify}, "harborfactory.oracle_verify", []workflowkit.ResourceKey{resourceTaskSnapshot, resourceSourceSnapshot, resourceEvidenceInitialVerify}, []workflowkit.ResourceKey{resourceEvidenceOracleVerify}, workflowkit.EffectEvidenceOnly, 1, checkVerdicts(), artifactInput("task_snapshot"), artifactInputWithSchema(CodeEdgeSourceSnapshotArtifact, CodeEdgeSourceSnapshotSchemaVersion), artifactInput("initial_verify_report"), artifactOutput("oracle_verify_report")),
			stage(TestsAnalysis, StageTaskAnalysis, []string{OracleVerify}, "harborfactory.tests_analysis", []workflowkit.ResourceKey{resourceTaskSnapshot, resourceSourceSnapshot, resourceEvidenceOracleVerify}, []workflowkit.ResourceKey{resourceEvidenceTestsAnalysis}, workflowkit.EffectEvidenceOnly, 1, checkVerdicts(), artifactInput("task_snapshot"), artifactInputWithSchema(CodeEdgeSourceSnapshotArtifact, CodeEdgeSourceSnapshotSchemaVersion), artifactInput("oracle_verify_report"), artifactOutput("tests_analysis_report")),
			...
			stage(QualityCheck, StageQuality, []string{SolutionReview}, "harborfactory.quality_check", []workflowkit.ResourceKey{resourceTaskSnapshot, resourceSourceSnapshot, resourceEvidenceTestsAnalysis, resourceReviewSolutionVerifier}, []workflowkit.ResourceKey{resourceEvidenceQuality}, workflowkit.EffectEvidenceOnly, 1, checkVerdicts(), artifactInput("task_snapshot"), artifactInputWithSchema(CodeEdgeSourceSnapshotArtifact, CodeEdgeSourceSnapshotSchemaVersion), artifactInput("tests_analysis_report"), reviewDecisionInput("solution_review_decision"), artifactOutput("quality_report")),
			stage(SimilarityCheck, StageSimilarity, []string{QualityCheck}, "harborfactory.similarity_check", []workflowkit.ResourceKey{resourceTaskSnapshot, resourceSourceSnapshot, resourceEvidenceQuality}, []workflowkit.ResourceKey{resourceEvidenceSimilarity}, workflowkit.EffectEvidenceOnly, 1, similarityVerdicts(), artifactInput("task_snapshot"), artifactInputWithSchema(CodeEdgeSourceSnapshotArtifact, CodeEdgeSourceSnapshotSchemaVersion), artifactInput("quality_report"), artifactOutput("similarity_report")),
			...
			stage(SubmissionLint, StageSubmission, []string{EvaluatorEvidenceHandoff}, "harborfactory.codeedge_lint", []workflowkit.ResourceKey{resourceTaskSnapshot, resourceSourceSnapshot, resourceEvidenceEvaluatorHandoff, resourceReviewEvaluatorEvidence}, []workflowkit.ResourceKey{resourceEvidenceSubmissionLint}, workflowkit.EffectEvidenceOnly, 1, checkVerdicts(), artifactInput("task_snapshot"), artifactInputWithSchema(CodeEdgeSourceSnapshotArtifact, CodeEdgeSourceSnapshotSchemaVersion), reviewDecisionInput("evaluator_evidence_handoff_decision"), artifactOutputWithSchema("submission_lint_report", CodeEdgeSubmissionReportSchemaVersion)),
			...
			operatorOnlyLocalPackageStage([]string{ResultReview}, []workflowkit.ResourceKey{resourceTaskSnapshot, resourceSourceSnapshot, resourceEvidenceSubmissionLint, resourceReviewModelResult}, []workflowkit.ResourceKey{resourceDeliveryPackage}, artifactInput("task_snapshot"), artifactInputWithSchema(CodeEdgeSourceSnapshotArtifact, CodeEdgeSourceSnapshotSchemaVersion), artifactInputWithSchema("submission_lint_report", CodeEdgeSubmissionReportSchemaVersion), reviewDecisionInput("model_result_decision"), artifactOutput("package_bundle")),
		},
	}
}
