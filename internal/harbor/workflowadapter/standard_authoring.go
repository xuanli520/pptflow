...
const (
	...
	// StandardAuthoringPackageAdmissionReportArtifact is the exported artifact
	// key for the CodeEdge package admission report.
	StandardAuthoringPackageAdmissionReportArtifact = standardAuthoringPackageAdmissionReportArtifact
	// StandardAuthoringPackageAdmissionReportSchemaVersion is the exported
	// schema version for the CodeEdge package admission report.
	StandardAuthoringPackageAdmissionReportSchemaVersion = standardAuthoringPackageAdmissionReportSchemaVersion
